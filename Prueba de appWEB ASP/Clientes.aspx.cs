...
namespace Prueba_de_appWEB_ASP
{
    public partial class Clientes : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (cliente.documentoCliente == ValidarCedula(txtDocumento.Text))
                {
            ...
            if (documentoCorrecto == true)
            {
                ...
                {
                    cliente.setDocumentoCliente(ValidarCedula(txtDocumento.Text));
                    cliente.setNombreCliente(txtNombre.Text);
                    cliente.setApellidoCliente(txtApellido.Text);
                    cliente.setDireccionCliente(txtDireccion.Text);
